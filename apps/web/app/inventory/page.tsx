...
export default function InventoryPage() {
  ...
  // Attendre que les traductions soient prêtes pour éviter les problèmes d'hydratation
  if (!ready) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center px-2 md:px-0">
          ...
          <h2 className="text-xl md:text-2xl font-bold mb-2 font-satoshi-bold text-opnskin-text-primary">
            Chargement...
          </h2>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center px-2 md:px-0">
          ...
          <Button onClick={() => window.location.href = '/api/auth/steam'} className="btn-opnskin flex items-center gap-2 w-full max-w-xs mx-auto text-base md:text-lg bg-opnskin-blue text-white hover:bg-opnskin-blue/80">
              <img src="/icons8-steam-128.png" alt="Steam" className="w-6 h-6 object-contain icon-steam" />
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center px-2 md:px-0">
          ...
          <p className="text-opnskin-text-secondary text-base md:text-lg">
