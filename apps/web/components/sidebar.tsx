  ...
  return (
    ...
    >
      ...
      <div className="flex-1 py-4 overflow-y-auto">
        ...
        {user?.isAdmin && (
          <div className="mt-6 pt-6 border-t border-opnskin-bg-secondary">
            <h3 className={cn("px-3 text-xs font-semibold text-opnskin-text-secondary uppercase mb-2", !expanded && "sr-only")}>Administration</h3>
            <nav className="space-y-1 px-2">
              <Link
                href="/admin/support"
                className={cn("nav-item h-12 flex items-center", pathname === "/admin/support" ? "nav-item-active" : "nav-item-inactive")}
