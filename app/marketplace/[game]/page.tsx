...
export default function MarketplaceGamePage() {
  try {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-red-500 mb-4">Erreur inattendue</h1>
          <p className="text-opnskin-text-secondary mb-4">{error?.message || 'Une erreur inconnue est survenue.'}</p>
          <Link href="/marketplace">
            <Button className="btn-opnskin">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Retour au marketplace
